...
# Company: TopStar
# Copyright © 2025 TopStar. All Rights Reserved.
# ==============================================================
...
Environment="XR_TELEOP_CERT=$HOME/.config/xr_teleoperate/cert.pem"
Environment="XR_TELEOP_KEY=$HOME/.config/xr_teleoperate/key.pem"
